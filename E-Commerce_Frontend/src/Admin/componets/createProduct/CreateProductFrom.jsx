...
const CreateProductForm = () => {
  ...
  const handleChange = (e) => {
    ...
    setProductData((prevState) => {
      //Crée une copie de l'état précédent (prevState) et met à jour la propriété dont le nom est name avec la nouvelle valeur (value)
            ...
            <TextField
              ...
              sx={{
                ...
                "& .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline": {
                  borderColor: "black", //bordure
                },
                "& .MuiInputLabel-root": {
                  color: "black", //etiquette
                },
                "&:hover .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline": {
                  borderColor: "black", //daz elyh
                },
                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {
                  borderColor: "black", //clicka elyh
                },
              }}
            />
          </Grid>
